...
from dat.views import (dat_add, dat_list, dat_update, dat_view, 
                       dat_destroy, export_dat_xls, export_dat_csv, Export_Dat_pdf)
...
urlpatterns = [
    ...
    path('export/pdf/<int:id>/', Export_Dat_pdf.as_view(), name='export_dat_pdf'),
]
