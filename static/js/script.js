...
$("body").append('<div class="fixed-button active"><a href="https://eventdrc.com/" target="_blank" class="btn btn-md btn-primary"><i class="fa fa-edit" aria-hidden="true"></i> En mode developpement</a> </div>');
